    ...
    <div class="font-body dark" :hidden="chartURL == ''">
        <div id="app">
            <nav class="bg-fox-2 text-fox-2 fixed left-0 top-0 z-30 flex h-12 w-full items-center border-b border-fox-500 px-4">
                ...
                <div class="hidden flex-1 justify-center md:flex">{{ currentChart.airport }} - {{ currentChart.author }}
                </div>
            </nav>
            <main class="bg-fox-1 text-fox-2 min-h-screen w-full pt-12 h-screen overflow-hidden">
                <div class="fox-app-swipe-target flex h-full w-full items-stretch">
                    <div class="z-20 w-0 transition-all xl:w-96"
                        style="transform: translateX(0px); transition-duration: 150ms;">
                        <div
                            class="bg-fox-2 flex flex-col items-stretch gap-4 p-4 relative z-20 h-full w-screen transition-transform xs:w-96 -translate-x-full xl:translate-x-0">
                            <div class="flex items-center gap-2">
                                <h2 class="flex-grow font-semibold">Charts</h2>
                            </div>
                            <div class="flex flex-col items-stretch">
                                <div class="transition-all h-0">
                                </div>
                                <ol class="flex chart-app-tabs"
                                    data-intro="Use these buttons to switch between types of chart" data-step="3">
                        ...
                        <div class="bg-fox-300 dark:bg-fox-850 fox-app-swipe-target h-full w-full">
                            <div class="fox-app-swipe-target relative h-full overflow-hidden outline-none">
                                <div class="relative h-full overflow-hidden outline-none">
                                    <div class="fox-app-swipe-target h-full focus:outline-none" tabindex="0"
                                        id="ligmatizer">
